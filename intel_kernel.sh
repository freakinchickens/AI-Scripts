...
BUILD_DIR="${HOME}/intel_kernel_build"
# ---------------------
...
echo "=== 5. Optimizing Configuration for Intel Only ==="
# Disable AMD-specific CPU features and microcode
...
# Optimize compilation flags for your specific Intel CPU architecture
...
echo "=== 6. Compiling Kernel (Intel Optimized) ==="
# KCFLAGS="-march=native" forces GCC to optimize instructions for your exact Intel model
...
echo "=== SUCCESS: Intel-only Kernel compiled and installed ==="
